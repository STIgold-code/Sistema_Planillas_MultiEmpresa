...
import type { LineaEntrega } from '../hooks/use-entregas';
...
interface Props {
  ...
  index: number;
  onChange: (index: number, linea: LineaEntrega) => void;
  onRemove: (index: number) => void;
  removable: boolean;
}

export function LineaEntregaRow({
  linea,
  tipos,
  index,
  onChange,
  ...
  const update = (patch: Partial<LineaEntrega>) =>
